"""Web-interface security auditor — read-only HTTP posture, header checks, directory
enumeration, SSL/TLS assessment, and common device web-interface weakness detection."""
...
class WebScanner:
    """Read-only security auditor for a host's web interface.

    Covers device admin panels and embedded web servers (routers, cameras, NAS,
    PLC/HMI/BMS), not general web-application penetration testing.
    """
